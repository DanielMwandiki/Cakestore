...
?>
        ...
        <li id="customers"><a href="customer.php"><i class="fa fa-user"></i> <span>Customers</span> </a></li>
        ...
        <!--<li id="newarival"><a href="overview.php"><i class="fa  fa-star-half-o"></i> <span>Customer Favourites</span> </a></li>-->
        ...
        <li id="massage"><a href="./massage.php"><i class="fa fa-envelope"></i> <span>Messages</span>
