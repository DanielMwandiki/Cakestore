...
<head>
  ...
  <title>Admin Dashboard</title><title>Admin Dashboard</title><link rel="icon" href="../img/favicon2.jpg">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <label>
                      <input type="radio" name="cat" id="optionsRadios1" value="Cakes" checked="">
                      Cakes
                    </label>
                  </div></div>
                  ...
                  <div class="col-md-4"> <div class="radio">
                    <label>
                      <input type="radio" name="cat" id="optionsRadios2" value="Muffins">
                      Muffins
                    </label>
                  </div></div>
                  ...
                  <div class="col-md-4">  <div class="radio">
                    <label>
                      <input type="radio" name="cat" id="optionsRadios3" value="Gift Packs" >
                      Gift Packs
                    </label>
                  </div></div>
